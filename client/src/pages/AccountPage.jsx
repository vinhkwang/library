...
export default function AccountPage() {
  ...
  return (
    <div className="max-w-md space-y-10">
      ...
      <section>
        <h2 className="mb-4 text-lg font-semibold text-red-700">Delete account</h2>
        ...
        >
          ...
          <button
            ...
            className="w-full rounded bg-red-700 px-3 py-2 text-sm text-white disabled:opacity-50"
          >
